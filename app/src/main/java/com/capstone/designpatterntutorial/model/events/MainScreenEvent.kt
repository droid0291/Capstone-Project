 ...
 */
class MainScreenEvent(private var mainScreenData: MainScreenData?) {
    fun getMainScreenData(): MainScreenData? {
        return mainScreenData
    }

    fun setMainScreenData(mainScreenData: MainScreenData?) {
