 ...
 */
class FavoriteScreenEvent(private var favoriteScreenData: FavoriteScreenData?) {
    fun getFavoriteScreenData(): FavoriteScreenData? {
        return favoriteScreenData
    }

    fun setFavoriteScreenData(favoriteScreenData: FavoriteScreenData?) {
