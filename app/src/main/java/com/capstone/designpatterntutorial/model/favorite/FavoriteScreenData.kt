 ...
 */
class FavoriteScreenData : Parcelable {
    ...
    override fun equals(obj: Any?): Boolean {
        ...
        val that = obj as FavoriteScreenData?
    ...
    companion object {
        ...
        val CREATOR: Creator<FavoriteScreenData?>? = object : Creator<FavoriteScreenData?> {
            override fun createFromParcel(`in`: Parcel?): FavoriteScreenData? {
                return FavoriteScreenData(`in`)
            }

            override fun newArray(size: Int): Array<FavoriteScreenData?>? {
                return arrayOfNulls<FavoriteScreenData?>(size)
            }
        }
    }
}