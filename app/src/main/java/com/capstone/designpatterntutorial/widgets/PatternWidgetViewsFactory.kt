 ...
 */
class PatternWidgetViewsFactory(private val mContext: Context?, intent: Intent?) : RemoteViewsFactory {
    private val appWidgetId: Int
    private var cursor: Cursor? = null
    override fun onCreate() {
        Log.d(ContentValues.TAG, "Widget :: onCreate")
    ...
    override fun onDataSetChanged() {
        ...
        Log.d(ContentValues.TAG, "Widget :: onDataSetChanged")
        cursor = mContext.getContentResolver().query(FavoritePatternEntry.CONTENT_URI,
                FavoritePatternEntry.FAVORITE_PATTERN_COLUMNS,
                null, null, FavoritePatternEntry.COLUMN_NAME)
    ...
    override fun getCount(): Int {
        return if (cursor != null) cursor.getCount() else 0
    }

    override fun getViewAt(position: Int): RemoteViews? {
        Log.d(ContentValues.TAG, "Widget :: getViewAt : $position")
        val row = RemoteViews(mContext.getPackageName(),
        ...
        val clickIntent = Intent(mContext, HomeActivity::class.java)
