 ...
 */
@Module
class BaseModuleApplication(var mMyApplication: MyApplication?) {
    @Provides
    @Singleton
    ...
    @Provides
    @Singleton
    fun providesMainScreenConverter(application: Application?): MainScreenConverter? {
    ...
    fun providesHomePresenter(): HomePresenter? {
        return HomePresenter(mMyApplication)
    }

    @Provides
    @Singleton
    fun providesFavoritePresenter(): FavoritePresenter? {
        return FavoritePresenter(mMyApplication)
    }
